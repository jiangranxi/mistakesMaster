    ...
    <div class="form-wrapper">
      <div class="register-form">
        ...
        <div class="form-row">
          ...
          <div class="select-box" @click="showJobPicker = !showJobPicker">
            <span>{{ job || '老师' }}</span>
        ...
        <div class="form-row">
          ...
          <div class="select-box" @click="showSubjectPicker = !showSubjectPicker">
            <span>{{ subject || '数学' }}</span>
            <i class="ri-arrow-down-s-line dropdown-icon"></i>
          </div>
          <span class="spacer-16-h"></span>
          <span class="hint">选择学科</span>
        </div>
