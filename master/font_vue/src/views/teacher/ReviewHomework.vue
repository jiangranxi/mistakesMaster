        ...
        <table class="data-table">
          <thead>
            <tr>
              ...
              <th class="col-class sortable" @click="toggleSort('class')">班级<span class="sort-arrows" :data-sort="sortKey==='class'?sortDir:''"><span class="sort-arrow up"></span><span class="sort-arrow down"></span></span></th>
