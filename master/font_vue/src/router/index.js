...
const routes = [
  ...
  // === 教师端 ===
  {
    ...
    children: [
      ...
      { path: 'exercises/buy/:id', name: 'TeacherExerciseBuy', component: () => import('@/views/PurchaseView.vue') },
  ...
  // === 学生端 ===
  {
    ...
    children: [
      ...
      { path: 'exercises/buy/:id', name: 'StudentExerciseBuy', component: () => import('@/views/PurchaseView.vue') },
